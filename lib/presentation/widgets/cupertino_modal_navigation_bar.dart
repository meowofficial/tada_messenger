...
const double _kNavBarPersistentHeight = 56.0;
...
/// to also has a [CupertinoModalNavigationBar] or a [CupertinoSliverNavigationBar]
...
///
/// By default, only one [CupertinoModalNavigationBar] or [CupertinoSliverNavigationBar]
...
/// This example shows a [CupertinoModalNavigationBar] placed in a [CupertinoPageScaffold].
...
class CupertinoModalNavigationBar extends StatefulWidget implements ObstructingPreferredSizeWidget {
  /// Creates a navigation bar in the iOS style.
  const CupertinoModalNavigationBar({
    Key? key,
    this.leading,
  ...
  ///
  /// Defaults to a common tag between all [CupertinoModalNavigationBar] and
  ...
  @override
  _CupertinoModalNavigationBarState createState() {
    return _CupertinoModalNavigationBarState();
  }
}
...
class _CupertinoModalNavigationBarState extends State<CupertinoModalNavigationBar> {
...
///
/// Like [CupertinoModalNavigationBar], it also supports a [leading] and [trailing]
...
/// See also:
///
///  * [CupertinoModalNavigationBar], an iOS navigation bar for use on non-scrolling
///    pages.
...
/// A nav bar back button typically used in [CupertinoModalNavigationBar].
///
/// This is automatically inserted into [CupertinoModalNavigationBar] and
